...
) ENGINE=InnoDB AUTO_INCREMENT=17411 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `following_strategy`
  MODIFY `following_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=72;
--
...
--
ALTER TABLE `portfolio_strategy`
  MODIFY `portfolio_strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `request_broker`
  MODIFY `request_broker_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- 테이블의 AUTO_INCREMENT `strategy`
--
ALTER TABLE `strategy`
  MODIFY `strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=70;
--
...
--
ALTER TABLE `strategy_daily`
  MODIFY `daily_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17411;
--
...
--
ALTER TABLE `strategy_item`
  MODIFY `strategy_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=199;
--
