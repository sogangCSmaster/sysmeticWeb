...
CREATE TABLE IF NOT EXISTS `qna` (
  ...
  `strategy_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `uid` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- 테이블 구조 `request_broker`
--

CREATE TABLE IF NOT EXISTS `request_broker` (
  `request_broker_id` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `company` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `location` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `work_year` int(11) NOT NULL DEFAULT '0',
  `position` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `my_strategy_count` int(11) NOT NULL DEFAULT '0',
  `open_strategy_count` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `strategy` (
  ...
  `total_profit_rate` double NOT NULL DEFAULT '0',
  `yearly_profit_rate` double NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `strategy_daily` (
  ...
  `reg_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `inflow` int(11) NOT NULL DEFAULT '0',
  `outflow` int(11) NOT NULL DEFAULT '0',
  `futures_trade_amount` int(11) NOT NULL DEFAULT '0',
  `options_trade_amount` int(11) NOT NULL DEFAULT '0',
  `fee` int(11) NOT NULL DEFAULT '0',
  `PL` int(11) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=18910 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `platform_uid` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `user_password` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `password_code` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nickname` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `picture` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `picture_s` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `is_request_trader` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `is_verify` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0' COMMENT '이메일인증여부',
  `is_delete` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `reg_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
ALTER TABLE `attachment`
  ADD PRIMARY KEY (`attachment_id`), ADD KEY `notice_id` (`notice_id`);
...
ALTER TABLE `portfolio_strategy`
  ADD PRIMARY KEY (`portfolio_strategy_id`), ADD KEY `portfolio_id` (`portfolio_id`), ADD KEY `strategy_id` (`strategy_id`);
...
--
-- 테이블의 인덱스 `request_broker`
--
ALTER TABLE `request_broker`
  ADD PRIMARY KEY (`request_broker_id`), ADD KEY `uid` (`uid`);
...
ALTER TABLE `strategy_account`
  ADD PRIMARY KEY (`account_id`), ADD KEY `strategy_id` (`strategy_id`), ADD KEY `target_date` (`target_date`);
...
ALTER TABLE `strategy_funding`
  ADD PRIMARY KEY (`funding_id`), ADD KEY `strategy_id` (`strategy_id`), ADD KEY `target_date` (`target_date`);
...
--
ALTER TABLE `user`
  ADD PRIMARY KEY (`uid`), ADD KEY `email` (`email`), ADD KEY `platform_uid` (`platform_uid`);
...
--
ALTER TABLE `broker`
  MODIFY `broker_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=34;
--
-- 테이블의 AUTO_INCREMENT `following_strategy`
--
ALTER TABLE `following_strategy`
  MODIFY `following_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=75;
--
...
--
ALTER TABLE `portfolio_strategy`
  MODIFY `portfolio_strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- 테이블의 AUTO_INCREMENT `qna`
--
ALTER TABLE `qna`
  MODIFY `qna_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- 테이블의 AUTO_INCREMENT `request_broker`
--
ALTER TABLE `request_broker`
  MODIFY `request_broker_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- 테이블의 AUTO_INCREMENT `strategy`
--
ALTER TABLE `strategy`
  MODIFY `strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=73;
--
...
--
ALTER TABLE `strategy_daily`
  MODIFY `daily_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18910;
--
-- 테이블의 AUTO_INCREMENT `strategy_funding`
--
ALTER TABLE `strategy_funding`
  MODIFY `funding_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- 테이블의 AUTO_INCREMENT `strategy_item`
--
ALTER TABLE `strategy_item`
  MODIFY `strategy_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=214;
--
...
--
ALTER TABLE `univ_value`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
