...
--
ALTER TABLE `following_strategy`
  MODIFY `following_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `portfolio_strategy`
  MODIFY `portfolio_strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `strategy`
  MODIFY `strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `strategy_daily`
  MODIFY `daily_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2919;
--
...
--
ALTER TABLE `strategy_item`
  MODIFY `strategy_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
