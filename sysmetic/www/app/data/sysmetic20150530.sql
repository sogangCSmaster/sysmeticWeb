...
) ENGINE=InnoDB AUTO_INCREMENT=16228 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `following_strategy`
  MODIFY `following_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=69;
--
...
--
ALTER TABLE `request_broker`
  MODIFY `request_broker_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- 테이블의 AUTO_INCREMENT `strategy`
--
ALTER TABLE `strategy`
  MODIFY `strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=64;
--
...
--
ALTER TABLE `strategy_daily`
  MODIFY `daily_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16228;
--
...
--
ALTER TABLE `strategy_item`
  MODIFY `strategy_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=154;
--
