...
--
ALTER TABLE `auth_token`
  MODIFY `token_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=42;
--
...
--
ALTER TABLE `portfolio_strategy`
  MODIFY `portfolio_strategy_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `strategy_item`
  MODIFY `strategy_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=210;
--
