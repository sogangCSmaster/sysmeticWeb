...
<table width="710" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
        <td colspan="2" bgcolor="#f0f0f0">
            <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                    <td height="34" valign="top" style="font-family:돋움, Dotum; font-size:14px; color:#828894;"><b>SYSMETIC TRADERS 회원가입을 환영합니다.</b></td>
                </tr>
                <tr><td height="2" bgcolor="#828894"></td></tr>
                <tr><td height="25"></td></tr>
                <tr>
                    <td style="font-family:돋움, Dotum; font-size:14px; color:#828894; line-height:25px;">
                        <b><?php echo htmlspecialchars($name) ?>님.</b><br />
                        Sysmetic Traders 를 이용해 주셔서 고맙습니다.<br />
                        Sysmetic Traders 와 함께 투자하는 전략들을 만나고, 가장 좋은 투자전략을 Follow 하세요. <br /><br />

                        Sysmetic Traders 의 성장을 함께해 주세요. <br /> <br />
                        <b>고맙습니다.</b>
                    </td>
                </tr>
    ...
    <tr>
        <td colspan="2" style="font-family:돋움, Dotum; font-size:11px; color:#a4a9b3; line-height:21px;">
            이 메일은 SYSMETIC TRADERS 회원가입 시 자동으로 발송되는 메일로 메일주소는 발신전용입니다.
        </td>
    </tr>
