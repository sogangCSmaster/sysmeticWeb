										...
										<tr class="photo">
											...
											<td>
												<div class="wrapping photo">
													...
													<p class="txt_summary">* 반드시 가입자 본인의 사진을 올려야 합니다.</p>
											...
											<td>
												<div class="wrapping">
													<div class="custom_selectbox" style="margin-right:10px; width:188px;">
														...
														<select id="brand_choice" name="roomName">
															<option value="" selected="selected">증권사 선택</option>
															<option value="">삼성증권</option>
															<option value="">KB증권</option>
														</select>
													</div>
													<div class="custom_selectbox" style="margin-right:10px; width:188px;">
														<label for="area_choice2">지역 선택</label>
														<select id="area_choice2" name="roomName">
															<option value="" selected="selected">지역 선택</option>
															<option value="">서울</option>
															<option value="">경기</option>
														</select>
													...
													<div class="input_box" style="width:188px;">
														<input type="text" id="" name="" placeholder="지점 입력" />
													</div>
												</div>
												<div class="input_box" style="margin-top:10px; width:788px;">
													<input type="text" id="" name="" placeholder="구/군 이하 상세주소 입력" style="padding:0 1.5%; width:97%;" />
												</div>
											</td>
										</tr>
										<tr class="photo">
											...
											<td>
												<div class="wrapping photo namecard">
													<div class="photo_box"></div>
													<input type="file" id="photo_upload2" name="photo_upload2" />
													<label for="photo_upload2" class="btn_default">사진첨부</label>
													<button type="button" class="btn_default">삭제하기</button>
												</div>
											</td>
										</tr>
