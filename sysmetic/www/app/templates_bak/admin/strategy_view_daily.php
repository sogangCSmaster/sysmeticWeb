        ...
        <div class="layer_form">
            <table border="0" cellspacing="1" cellpadding="0" class="admin_table">
                ...
                <tr>
                    ...
                    <td><input id="flow" name="flow" type="text" title="입출금" value="0" required="required" onkeyup="inputNumberFormat(this)" /></td>
                    <td><input id="PL" name="PL" type="text" title="일손익" value="0" required="required" onkeyup="inputNumberFormat(this)" /></td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="layer_form">
            <table border="0" cellspacing="1" cellpadding="0" class="admin_table">
                ...
                <tr>
                    ...
                    <td><input id="edit_flow" name="flow" type="text" title="입출금" value="" required="required" onkeyup="inputNumberFormat(this)" /></td>
                    <td><input id="edit_PL" name="PL" type="text" title="일손익" value="" required="required" onkeyup="inputNumberFormat(this)" /></td>
                </tr>
                </tbody>
            </table>
