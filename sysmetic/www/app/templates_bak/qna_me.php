    ...
    <div id="wrap">
        <div id="content" class="view">
            ...
            <div class="strategy_view qna">
                <div class="tab">
                    <a href="/qna" title="내가 한 질문" class="tab_off"><span class="ir">내가 한 질문</span></a>
                    <a href="/qna_me" title="내가 받은 질문" class="tab_on"><span class="ir">내가 받은 질문</span></a>
                </div>
            </div>
            <!-- // -->
			<?php if(count($qs)){ ?>
            <table border="0" cellspacing="0" cellpadding="0" class="board">
            <col width="160" /><col width="*" /><col width="160" /><col width="130" />
                <thead>
                <tr>
                    <td class="left">날짜</td>
                    <td>전략명</td>
				...
				<?php foreach($qs as $q){ ?>
                <tr>
                    <td class="date"><?php echo date('<b>Y.m.d</b> H:i:s', strtotime($q['reg_at'])) ?></td>
                    ...
                    <td><?php echo htmlspecialchars($q['target_value_text']) ?></td>
                    <td class="btn">
