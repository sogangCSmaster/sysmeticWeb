                ...
                <? require_once $skinDir."mypage/sub_menu.php" ?>
					...
					<div class="content my_counsel">
						<div class="detail_a">
							...
							<div class="answer">
								<div class="row_t">
									...
									<span class="name"><?=$qna['answer_name']?></span>
								</div>
								<p class="cont">
									<?=nl2br($qna['answer'])?>
								</p>
						...
						<div class="btn_area">
                            ...
                            if (!$qna['answer']) {
                            ?>
                            <a href="/mypage/customer/<?=$qna['cus_id']?>/modify" class="btn modify">수정</a>
                            <?
                            } else {
                            ?>
							...
							<a href="/mypage/customer" class="btn list">목록</a>
						</div>
					</div>
	...
	<div class="contents">
		...
		<div class="cont">
			...
			<div class="btn_area half">
				<a href="/mypage/customer/<?=$qna['cus_id']?>/delete" class="btn_common_red" onclick="commonLayerClose('delete_counsel')">예</a>
