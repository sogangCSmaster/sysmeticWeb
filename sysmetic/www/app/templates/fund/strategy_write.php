...
<head>
    ...
    $(function(){
        ...
        // 트레이더 검색
        $('.btn_search_trader').on('click', function(){
                ...
                <div class="content_area regist">
                    <form action="/fund/strategies/write" method="post" id="reg_strategy_form" enctype="multipart/form-data">
                        <fieldset>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="wrapping">
												...
												<div class="btn_search_trader"><a href="javascript:;" class="btn">검색</a></div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="check_category">
												...
												?>
                                                <td style="height:40px;border-bottom: 0px solid #bcbcbc;"><input name="item_ids[]" id="item<?php echo $item['item_id'] ?>" class="option" type="checkbox" value="<?php echo $item['item_id'] ?>" data-role="item" /><label for="item<?php echo $item['item_id'] ?>"><?php echo htmlspecialchars($item['name']) ?></label></td>
                                                <?
													if($a==4){
														echo "</tr><tr>";
														$a=0;
							...
							<div style="padding-top:20px;font-size:15px;color:#0000ff">※ 상품은 관리자 승인 후 최종 등록됩니다</div>
