		...
		<div class="container main">
						...
						<ul>
							...
							<li>
								...
								<div class="user_info">
									...
									<div class="info">
										<strong class="name n_gothic"><?php echo htmlspecialchars($sm_top_strategies['name']) ?></strong>
							...
							<li>
								...
								<div class="user_info">
									...
									<div class="info">
										<strong class="name n_gothic"><?php echo htmlspecialchars($fund_top_strategies['name']) ?></strong>
			...
			<div class="sec07">
				<div class="area">
					...
					<p class="title"><a href="/cs/partners"><img src="images/main/txt_section07_title.gif" alt="파트너" /></a></p>
					...
					<div class="owl-carousel banner_list">
						...
						<div class="item">
							<a href="<?=$v['url']?>" target="_blank">
								<img src="/data/banner/<?=$v['banner_image']?>" alt="<?=$v['subject']?>" />
							</a>
						</div>
                        <? } ?>
					</div>
