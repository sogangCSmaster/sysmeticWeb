    ...
    <div id="wrap">
        <div id="content" class="view">
            ...
            <div class="strategy_view qna">
                <div class="tab">
                    <a href="/qna" title="내가 한 질문" class=""><span class="ir">내가 한 질문</span></a>
                    <a href="/my_answers" title="내가 받은 질문" class="tab_on"><span class="ir">내가 받은 질문</span></a>
                </div>
            </div>
			<?php } ?>
