...
<meta charset="UTF-8" />  
	...
	$(function(){
		...
		$('#form_signup').submit(function(){
			<?php if(empty($_SESSION['temp_account']['email'])){ ?>
			if(!$('#email1').val()){
...
<body>
    ...
    <div id="wrap">
        <div id="content" class="view">
			...
			<form action="/signup/<?php echo htmlspecialchars($_SESSION['temp_account']['platform']) ?>" method="post" id="form_signup">
            ...
            <div class="user_info">
                <dl>
                    ...
                    <dd class="mail">
						...
						<?php }else{ ?>
						<?php echo $_SESSION['temp_account']['email'] ?>
						<?php } ?>
                    </dd>
					<dt>닉네임</dt>
                    <dd>
            ...
            <div class="user_info">
                <dl>
                    <dt>이름</dt>
                    <dd>
                        <input id="name" name="name" type="text" title="이름" value="<?php if(!empty($_SESSION['temp_account']['nickname'])) echo htmlspecialchars($_SESSION['temp_account']['nickname']) ?>" />
                        <span>* 사이트 이용 시 사용할 이름을 입력해 주세요.</span>
                    </dd>
                    <dt>휴대폰</dt>
                    <dd>
