            ...
            <div id="type_list" style="">       
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="list_head">
                    ...
                    <tr>
                        ...
                        <td style="width:109px;"><a href="?sort=mdd&amp;sort_by=<?php if($sort_by == 'asc') echo 'desc'; else 
                        echo 'asc'; ?>" class="sorting">MDD</a></td>
                        <td style="width:109px;"><a href="?sort=sharp_ratio" class="sorting">SM Score</a></td>
                ...
                <div class="lanking_list">
                    <dl>
                        ...
                        <dd class="graph">
                            <div id="strategy_graph<?php echo $strategy['strategy_id'] ?>" data-role="strategy_graph" data-graph-data="<?php $c_array = array(); foreach($strategy['daily_values'] as $v){ $c_array[] = $v['c_price']; } echo '['.implode(',', $c_array).']'?>" style="width:127px;height:120px;"></div>
                        </dd>
                        <dd class="profit">
                            <dl class="tool">
                                <dt>누적 수익률</dt>
                                <dd><?php if(count($strategy['daily_values'])) echo number_format($strategy['daily_values'][count($strategy['daily_values'])-1]['total_profit_rate']);else echo '0' ?>%</dd>
                                <dt>연간 수익률</dt>
                                <dd>
                                <?php if(isset($strategy['yearly_profit_rate'][date('Y').''])) echo $strategy['yearly_profit_rate'][date('Y').'']; else echo '0' ?>%
                                </dd>
                                <dt><b>원금</b>(<?php echo htmlspecialchars($strategy['currency']) ?>)</dt>
                                <dd><?php echo number_format($strategy['daily_values'][count($strategy['daily_values'])-1]['principal']) ?></dd>
                            </dl>
                        </dd>
                        <dd class="mdd">
                        ...
                        <dd class="self"><?php if(isset($strategy['daily_values'][count($strategy['daily_values'])-1]['sharp_ratio'])) echo $strategy['daily_values'][count($strategy['daily_values'])-1]['sharp_ratio']; else echo '0' ?></dd>
