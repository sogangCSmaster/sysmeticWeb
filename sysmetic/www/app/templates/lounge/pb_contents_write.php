...
<head>
    ...
    function fileDelete(e) {
        ...
        if (savename != "") {
            $.post('/lounge/contents/delete_file', {'savename':savename}, function(data) {
                if (data == 'success') {
                    $(e).parent().remove();
                } else {
                ...
                <div class="area">
					...
					<div class="content board_write">	
						<div class="page_title_area no_bg">
							<p class="page_title n_squere">공지·칼럼 – 글쓰기 </p>
							<p class="page_summary">공지·칼럼을 등록 하실 수 있습니다.</p>
						</div>
						<div class="form_box">
                            <? if (!$info['cidx']) { ?>
							<form id="regFrm" action="/lounge/<?=$pb['uid']?>/contents/write" method="post" enctype="multipart/form-data">
                            <? } else { ?>
							<form id="regFrm" action="/lounge/<?=$pb['uid']?>/contents/<?=$info['cidx']?>/modify" method="post" enctype="multipart/form-data">
                            <? } ?>
								<fieldset>
												...
												<td>
													<div class="wrapping">
														<div class="input_box" style="width:298px;">
															...
															<input type="file" id="images" name="images" data-url="/lounge/contents/upload_images" />
														</div>
												...
												<td>
													<div class="wrapping">
														<div class="input_box" style="width:298px;">
															...
															<input type="file" id="files" name="files" data-url="/lounge/contents/upload_files" />
														</div>
									...
									<div class="btn_area">
										<a href="/lounge/<?=$pb['uid']?>/contents" class="btn_common_gray btn_cancel">취소</a>
