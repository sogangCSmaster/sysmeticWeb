					...
					<div class="content cs_common_detail">
						...
						<div class="cont">
							...
							<div class="picture">
                                ...
                                foreach ($imgs as $v) {
                                ?>
								<img src="/media/<?=$v['save_name']?>" alt="<?=$v['file_name']?>" /><br />
                                <?
                                }
                                ?>
							</div>
								...
								<dl>
									...
									<dd>
										<ul>
											...
											<li>
												<?=$v['file_name']?>
												<a href="/cs/download/media/<?=$v['fid']?>"><img src="/images/sub/btn_file_download.gif" alt="다운로드" /></a>
											</li>
                                            <?
                                            }
                                            ?>
						...
						<div class="btn_area">
							<a href="/cs/media" class="btn list">목록</a>
						</div>
					</div>
