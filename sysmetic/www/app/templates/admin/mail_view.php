        ...
        <div id="content" class="view">
            ...
            <div id="strategy_view1" class="strategy_view">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="thead">발송대상</td>
                        <td><?php echo $mail['target_type']; ?></td>
                    </tr>
                    <tr>
                        <td class="thead">메일 내용</td>
                        <td class="mail_txt">   
						<?php
							//echo nl2br(htmlspecialchars($mail['subject'])) 

							$notice_content = $mail['subject'];
							ob_start();
							if($mail_type == 'promotion'){
								include 'mail_promotion.php';
							}else{
								include 'mail_notice.php';
							}
