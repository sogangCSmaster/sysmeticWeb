    ...
    <div id="wrap">
        <div id="content" class="view">
            ...
            <tbody>
                ...
                <tr>
                    <td class="thead">메인노출</td>
                    <td colspan="3">
                        <p>
                            <input id="main1" name="is_main" type="radio" title="노출" value="1"<?php if($broker['is_main']) echo ' checked="checked"' ?> /> <label for="main1">노출</label>&nbsp;&nbsp;
                            <input id="main2" name="is_main" type="radio" title="비노출" value="0"<?php if(!$broker['is_main']) echo ' checked="checked"' ?> /> <label for="main2">비노출</label>
                        </p>
                    </td>
                </tr>
                <tr><td colspan="4" class="line"></td></tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="url" name="url" type="text" title="홈페이지 URL" value="<?php echo htmlspecialchars($broker['url']) ?>" />
                    </td>
                </tr>
                <tr>
                    <td class="thead">계좌개설 URL</td>
                    <td colspan="3">
                        <input id="url2" name="url2" type="text" title="계좌개설 URL" value="<?php echo htmlspecialchars($broker['url2']) ?>" />
                    </td>
                </tr>
                <tr>
