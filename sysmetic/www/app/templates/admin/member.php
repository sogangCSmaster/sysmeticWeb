...
<body>
    ...
    <div id="wrap">
        <div id="content" class="view">
            ...
            <input type="hidden" name="redirect_url" value="/admin/users" />
            <table border="0" cellspacing="1" cellpadding="0" class="admin_table">
                ...
                <tr>
                    ...
                    <td>
					<?php if (($user['user_type'] == 'T' && $user['is_request_trader']) || ($user['user_type'] == 'P' && $user['is_request_pb'])){ ?>
					<span class="waiting">대기</span><br />
					<?php } ?>
					<?php
            ...
            <fieldset class="admin">
                ...
                <div class="select open" style="width:100px;">
                    ...
                    <ul class="iList">
                        ...
                        <li><input name="user_type" id="member1" class="option" type="radio" value="N" /><label for="member1">일반회원</label></li>
                        ...
                        <li><input name="user_type" id="member4" class="option" type="radio" value="A" /><label for="member4">슈퍼관리자</label></li>
                    </ul>
                </div> 
                &nbsp;(으)로 &nbsp;&nbsp;
