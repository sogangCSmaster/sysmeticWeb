            ...
            <div class="form_box">
                ...
                <div class="row">
                    ...
                    <div class="input_box in_btn">
                        <input type="hidden" id="strategy_id" value="" />
...
$(function(){
    ...
    $('#btn_follow').click(function(){
        ...
        var strategy_id = $('.strategy_follow #strategy_id').val();
        if (!strategy_id) {
            ...
            $.post('/strategies/'+strategy_id+'/follow', {type:'json', group_id: group_id}, function(data){
                if (data.result) {
                    $('#btn_follow'+strategy_id).attr('title', 'UnFollow').attr('class', 'btn_unfollow').data('role', 'unfollow').text('Unfollow -');
                    $('#follows_count'+strategy_id).text(parseInt($('#follows_count'+strategy_id).text()) + 1);
